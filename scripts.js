...
function pageUp(){
	...
	//I've prompted jQuery to put my new div inside the div with the id, "DocumentBox"
	...
	//It includes 3 parameters: the 1st parameter is the name of my json file, dataMovies.json
